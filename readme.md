...
### Step 3: Add attributes on elements that you want to animate
Let's change the font-size of an H1 element starting from 14px when the scrollbar position is <= 100px to 50px when the scrollbar position is 300ox
```html
<h1 data-aio-100="font-size: 14px"1 data-aio-300="font-size: 14px"></h1>
```
